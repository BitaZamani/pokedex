  ...
  if (detail) {
    return (
      <div
        ...
        style={{
          background: findColor({ types: detail.types }),
        }}
      >
        <div className="relative w-full">
          <div className="flex justify-center items-center p-4 absolute -top-56 z-10 right-0 translate-y-1/2  h-60 w-full">
            <img
              src={detail.sprites.other["official-artwork"].front_default}
              className="size-40 "
            />
          </div>
          <div className="w-11/12 max-w-[500px] h-[500px] overflow-y-auto mx-auto bg-gray-50 pt-20 mt-10 px-7 text-center relative">
